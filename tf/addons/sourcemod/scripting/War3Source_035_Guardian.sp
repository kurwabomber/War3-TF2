...
//Juggernaut
new Float:JuggernautHPR[9]={0.0,3.0,4.0,5.0,6.0,6.5,7.0,7.5,8.0};
new JuggernautHP[9]={0,20,30,40,50,55,60,65,70};
new Float:JuggernautMovespeed[9]={1.0,0.6,0.6,0.6,0.6,0.6,0.6,0.6,0.6};
new Float:JuggernautArmor[9]={0.0,8.0,8.0,8.0,8.0,8.0,8.0,8.0,8.0};
new Float:JuggernautDamage[9]={0.0,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15};
//Cleansing Flame
new Float:CleasningFlameDamage[9]={0.0,50.0,60.0,70.0,80.0,85.0,85.0,85.0,85.0};
new Float:CleansingFlameCooldown[9]={0.0,25.0,25.0,25.0,25.0,25.0,22.5,20.0,18.5};
new BeamSprite,HaloSprite;

//Chokeslam
new Float:ChokeslamDamage[9]={0.0,60.0,65.0,70.0,75.0,80.0,85.0,90.0,95.0};

//Steadfast Corruption
new Float:SteadfastCorruptionDamage[9]={0.0,100.0,110.0,120.0,130.0,135.0,140.0,145.0,160.0};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual(raceshortname,shortname,false)))
	{
		...
		SKILL_FIRST=War3_AddRaceSkill(thisRaceID,"Juggernaut","Take 40% less damage. Deal 15% more damage.\n+8 HPR, +70 MaxHP. -40% movespeed. (passive)",false,8);
		SKILL_SECOND=War3_AddRaceSkill(thisRaceID,"Cleansing Flame","Within a 500HU radius, deal 50 to 85 damage.\n25s cooldown. Using this also adds cooldown to other abilities. (+ability)",false,8);
		SKILL_THIRD=War3_AddRaceSkill(thisRaceID,"Chokeslam","Grab a nearby enemy, dealing 60 -> 95 dmg. Stuns for 1.5s.\n30s cooldown.  Using this also adds cooldown to other abilities. (+ability2)",false,8);
		ULT=War3_AddRaceSkill(thisRaceID,"Steadfast Corruption","Creates a shockwave arc with 550HU length.\nCast time is 2.5s. Deals 100 -> 160 dmg.\n45s cooldown. (+ultimate)",true,8);
