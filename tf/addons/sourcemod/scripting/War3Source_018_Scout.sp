...
new Float:FadeCoolDown[9]={0.0,10.0,8.0,6.0,4.0,4.0,3.0,2.0,1.0};
new FadeDurationREQ[9]={0,6,5,4,3,2,2,1,1};


new Float:EyeRadius[9]={0.0,400.0,500.0,700.0,800.0,900.0,1000.0,1100.0,1200.0};

new Float:DisarmChance[9]={0.0,0.06,0.10,0.13,0.15,0.16,0.17,0.18,0.19};
new Float:DisarmSeconds[9]={0.0,0.5,0.7,0.9,1.0,1.05,1.1,1.15,1.2};
new Float:MarksmanCrit[9]={0.0,0.3,0.45,0.7,0.8,0.825,0.85,0.875,0.9};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual("scout_o",shortname,false)))
	{
		...
		SKILL_TRUESIGHT=War3_AddRaceSkill(thisRaceID,"TrueSight","Enemies cannot be invisible or partially invisible around you. \n400-1100 units.\nDoes not affect spy cloak",false,8);
		SKILL_FADE=War3_AddRaceSkill(thisRaceID,"Blink","If standing still for 6 to 1 seconds, you go completely invisible.\nAny movement or damage (to or from you) makes you visible.",false,8);
		SKILL_DISARM=War3_AddRaceSkill(thisRaceID,"Disarm","6 to 19% chance to disarm the enemy on hit\n0.5 to 1.2 seconds to disarm victim.",false,8);
		ULT_MARKSMAN=War3_AddRaceSkill(thisRaceID,"Marksman","Standing still for 3 seconds, scout is able to deal 1.3-1.9x damage the further the target.\n1024 units or more deals maximum damage",true,8);
