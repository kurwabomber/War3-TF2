...
// Storm Bolt
new BoltDamage[9] = {0,10,20,30,40,45,50,55,60};
new Float:BoltRange[9]={0.0,150.0,175.0,200.0,225.0,250.0,275.0,300.0,325.0};
...
new Float:CleaveMultiplier[9] = {0.0,0.05,0.1,0.15,0.2,0.22,0.24,0.26,0.28};

// Warcry Buffs
new Float:WarcrySpeed[9]={1.0,1.06,1.09,1.12,1.15,1.175,1.2,1.225,1.250};
new Float:WarcryArmor[9]={0.0,1.2,1.4,1.6,1.8,1.9,2.0,2.1,2.2};

// Gods Strength
new Float:GodsStrength[9]={1.0,1.20,1.30,1.40,1.50,1.55,1.6,1.65,1.7};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual("hammerstorm",shortname,false)))
	{
		...
		SKILL_BOLT=War3_AddRaceSkill(thisRaceID,"Storm Bolt","(+Ability) Stuns enemies in 150 to 325 radius\nfor 0.4 seconds, deals 10 to 60 damage",false,8);
		SKILL_CLEAVE=War3_AddRaceSkill(thisRaceID,"Great Cleave","Your attacks splash 5 to 28 percent\ndamage to enemys within 200 units",false,8);
		SKILL_WARCRY=War3_AddRaceSkill(thisRaceID,"Warcry","Gain 1.2 to 2.2 physical armor,\nincreases your speed by 6 to 25 percent",false,8);
		ULT_STRENGTH=War3_AddRaceSkill(thisRaceID,"Gods Strength","Greatly enhance your damage by 20 to 70 percent for a short amount of time.\nChannels for 2.5 seconds before usage.",true,8);
