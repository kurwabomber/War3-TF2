...
// Chance/Info Arrays
float BashChance[9]={0.0,0.07,0.13,0.19,0.25, 0.27, 0.28, 0.29, 0.3};
float BashDuration[9]={0.0,0.05,0.1,0.15,0.20, 0.225, 0.25, 0.275, 0.3};
float TeleportDistance[9]={0.0,600.0,700.0,800.0,900.0, 950.0, 1000.0, 1150.0, 1200.0};
...
new DevotionHealth[9]={0,10,20,30,40,42,45,47,50};


// Effects
new BeamSprite,HaloSprite;

float WhiskSpeed[9]={1.0,1.04,1.08,1.12,1.16,1.17,1.18,1.19,1.2};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual(RACE_SHORTNAME,shortname,false)))
	{
		...
		SKILL_SPEED=War3_AddRaceSkill(thisRaceID,"Whisk","Increases movement speed by up to 20%.",false,8);
		SKILL_HEALTH=War3_AddRaceSkill(thisRaceID,"Devotion Aura","Gives you additional 10/20/30/40/42/45/47/50 health.",false,8);
		SKILL_BASH=War3_AddRaceSkill(thisRaceID,"Bash","7/13/19/25% chance to bash the enemy.\nRenders the enemy immobile for 0.05->0.3 seconds.",false,8);
		ULT_TELEPORT=War3_AddRaceSkill(thisRaceID,"Teleport","Teleport toward where you aim.\nUp to 1200 HU range. Ultimate Immunity has 350 blocking radius.",true,8);
