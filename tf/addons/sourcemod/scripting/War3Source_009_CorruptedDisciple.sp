...
// Chance/Data Arrays
new ElectricTideMaxDamage[9]={0,40,60,100,140,150,160,170,180};
...
new ConduitMaxHeal[9]={0,4,6,8,10,11,12,13,14};

new Float:StaticHealPercent[9]={0.0,0.15,0.30,0.45,0.60, 0.63, 0.66, 0.69, 0.72};
new StaticHealRadius=800;

new OverloadDuration=75; //HIT TIMES, DURATION DEPENDS ON TIMER
new OverloadRadius=500;
new OverloadDamagePerHit[9]={0,1,2,3,4,4,5,5,6};
new Float:OverloadDamageIncrease[9]={1.0,1.0125,1.015,1.020,1.025,1.0275,1.03,1.0325,1.035};
////
