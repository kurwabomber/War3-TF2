...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual("bh",shortname,false))){
		...
		SKILL_CRAZY=War3_AddRaceSkill(thisRaceID,"Blood Crazy","Those damaged by you will bleed for 2 HP per second for 2 - 7 seconds.",false,8);
		SKILL_FEAST=War3_AddRaceSkill(thisRaceID,"Feast","Heal 5-28 percent of the victim's max HP on kill",false,8);
		SKILL_SENSE=War3_AddRaceSkill(thisRaceID,"Blood Sense","Those who are below 15-40% max HP take critical damage",false,8);
		ULT_RUPTURE=War3_AddRaceSkill(thisRaceID,"Hemorrhage","The target will take damage if he moves.\nDuration Scales 4 to 8.5 seconds.",true,8);
