...
new PushPower[9]={0,1,2,3,4,5,5,6,6};
...
new Float:JumpDistance[9]={0.0,200.0,300.0,400.0,500.0,550.0,600.0,650.0,700.0};

new Float:SwimSpeed[9]={0.0,1.2,1.3,1.4,1.5,1.55,1.6,1.65,1.7};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual("frogger",shortname,false)))
	{
		...
		ULTIMATE =  War3_AddRaceSkill( thisRaceID, "Lilly Pads", "[Lvl 1]Can use any teleporter (blue/red) [Lvl 2]Teleporters instant recharge when you walk thru them\n[Lvl 3]Mini-Instant level 3 teleporter [Lvl 4]Build Double Dispensers", true, 4 );
