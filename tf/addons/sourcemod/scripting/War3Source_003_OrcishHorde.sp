...
new Float:CritMultiplier[] = {0.0,1.25,1.5,1.75,2.0,2.125,2.25,2.375,2.5};

// Orb Of Lightning
new Float:OrbAttackspeed[]={0.0,0.05,0.1,0.15,0.2,0.225,0.25,0.275,0.3};
new Float:OrbCleave[]={0.0,0.05,0.09,0.13,0.17,0.19,0.21,0.23,0.25};
new orbInflictor[MAXPLAYERS+1];
new bool:bOrbActivated[MAXPLAYERS+1];
//					   ^Inflictor	 ^current player

// Lightning Strike
new LSMaxDamage[]={0,60,60,60,60,70,80,90,100};
new Float:Cooldown[] = {30.0,30.0,27.5,25.0,20.0,19.0,18.0,17.0,16.0}; // cooldown
