...
new Float:RoarDuration[9]={0.0,0.2,0.4,0.6,0.7,0.75,0.8,0.85,0.9};
#endif
new Float:RoarCooldownTime=25.0;
new Float:ScalesPhysical[9]={0.0,1.0,1.66,2.33,3.0,3.33,3.66,4.0,4.33};
new Float:dragvec[3]={0.0,0.0,0.0};
new Float:DragonBreathRange[9]={0.0,400.0,450.0,500.0,550.0,575.0,600.0,625.0,650.0};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual("dragonborn_o",shortname,false)))
	{
		...
		SKILL_ROAR=War3_AddRaceSkill(thisRaceID,"Roar","(+Ability) Puts all those around you in a 400 radius in a fear state for 0.2-0.9 second.",false,8);
		SKILL_SCALES=War3_AddRaceSkill(thisRaceID,"Scales","1-4.33 physical armor",false,8);
		...
		ULTIMATE_DRAGONBREATH=War3_AddRaceSkill(thisRaceID,"Dragons Breath","Applies jarate effect for 5 seconds. 400-650 range.",true,8);
