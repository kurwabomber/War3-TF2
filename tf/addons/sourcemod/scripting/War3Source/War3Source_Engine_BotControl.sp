...
public War3Source_Engine_BotControl_OnPluginStart()
{
	...
	botSrambleSpawn = CreateConVar("war3_bots_scramble_onspawn", "0", "The bots scramble on spawn.");
	botLevelRandom = CreateConVar("war3_bots_scramble_random", "0", "Assign bots a random level up to war3_bots_scramble_level or just the defined level?");
...
public void PickRace(client)
{
	...
	if(CanSelectRace(client,variableRace))
	{
