...
new LucentBeamMin[] = {0, 4, 8, 12, 16,17,18,19,20};
new LucentBeamMax[] = {0, 7, 11, 15, 19,20,21,22,23};
...
// PRAYERS SONG
new Float:song_timer_count[]={0.0,9.0,7.0,5.0,3.0,2.75,2.5,2.25,2.0};   //90 secs, 70 secs, 50 secs, 30 secs
new Timer_Song_counter[Maximum_Players_array];

//new Float:Song_chance[5] = { 0.0, 0.75, 0.80, 0.85, 0.95 };  // .10, .25, .40, .60

// MAD MILK
new Float:MadMilkRadius[] = { 0.0, 400.0, 466.0, 550.0, 666.0, 700.0,750.0,800.0,850.0};
new Float:MadMilkDuration[] = { 0.0, 4.0, 6.0, 8.0, 10.0, 11.0,12.0,13.0,14.0};


// WINGS OF GLORY
//new Float:WingsOfGlory_Duration[5] = { 0.0, 2.0, 3.5, 4.5, 6.0 };
new Float:WingsOfGlory_Duration[] = { 0.0, 3.0, 5.0, 7.0, 9.0, 10.0, 11.0, 12.0, 13.0};
new Float:WingsOfGlory_Speed[] = { 0.0, 1.50, 2.00, 2.50, 3.00, 3.0, 3.0, 3.0, 3.0};
new Float:WingsofGlory_Cooldown_Timer = 22.0;

// HOLY SWORD DAMAGE
new Float:HolySword_extradmg[] = { 0.0, 0.10, 0.12 , 0.14, 0.16, 0.17, 0.18, 0.19, 0.2};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual(RACE_SHORTNAME,shortname,false)))
	{
		...
		SKILL_SONG=War3_AddRaceSkill(thisRaceID,"Prayers Song","Every 90 to 20 seconds, the lowest HP player on your team gets 50% of max health.",false,8);
		ABILITY_WINGSOFGLORY=War3_AddRaceSkill(thisRaceID,"Wings of Glory","[+ability] Flight for 3-13 seconds.\nLeveling increases speed & duration.\n1-2x speed modifier.",false,4);
		SKILL_HOLYSWORD=War3_AddRaceSkill(thisRaceID,"Powerful Judgement","10-20% more damage.",false,8);
		SKILL_MOONBEAM =War3_AddRaceSkill(thisRaceID,"Angel's Light","4-7 to 20-23 dmg. Autocast. 5s cooldown.",false,4);
		ULTIMATE_LORDSREWARD=War3_AddRaceSkill(thisRaceID,"Lords Reward","In a 400 to 850HU radius, splashes Mad Milk Effect for 4 to 14 seconds.",true,8);
