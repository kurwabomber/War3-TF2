...
//skill 1
new Float:FanOfKnivesTFChanceArr[]={0.0,0.02,0.03,0.05,0.08,0.09,0.1,0.11,0.12};
...
new Float:ShadowStrikeChanceArr[]={0.0,0.05,0.1,0.15,0.2,0.225,0.275,0.325,0.35};
new ShadowStrikeTimes[]={0,2,3,4,5,5,6,6,7};
...
new Float:VengenceTFHealHPPercent[]={0.0,0.25,0.5,0.75,1.0,1.1,1.2,1.3,1.5};
...
public OnWar3LoadRaceOrItemOrdered2(num,reloadrace_id,String:shortname[])
{
	if(num==RACE_ID_NUMBER||(reloadrace_id>0&&StrEqual(RACE_SHORTNAME,shortname,false)))
	{
		...
		SKILL_FANOFKNIVES=War3_AddRaceSkill(thisRaceID,"Fan Of Knives","Deals 50 damage to attacker. 2-12% chance to proc.",false,8);
		SKILL_BLINK=War3_AddRaceSkill(thisRaceID,"Immunity","25% Immunity chance per level.",false,4);
		SKILL_SHADOWSTRIKE=War3_AddRaceSkill(thisRaceID,"Shadow Strike","Chance to deal initial 20 damage and 5 aftertime damage.\nDOT attacks 2-7 times and has a 5-35% chance to proc.",false,8);
		ULT_VENGENCE=War3_AddRaceSkill(thisRaceID,"Vengence","When used: Heals for 25% to 150% of your max health. Cooldown is 20 seconds.",true,8);
