...
//leap
new Float:leapPower[9]={0.0,350.0,400.0,450.0,500.0, 500.0, 500.0, 500.0, 500.0};
new Float:leapPowerTF[9]={0.0,500.0,550.0,600.0,650.0, 675.0, 700.0, 725.0, 750.0};

//rewind
new Float:RewindChance[9]={0.0,0.1,0.15,0.2,0.25, 0.275, 0.3, 0.325, 0.35};
new RewindHPAmount[MAXPLAYERSCUSTOM];

//bash
new Float:TimeLockChance[9]={0.0,0.1,0.15,0.2,0.25, 0.275, 0.3, 0.325, 0.35};

//sphere
new Float:ultRange=200.0;
new Handle:ultCooldownCvar;
new Float:SphereTime[9]={0.0,3.0,3.5,4.0,4.5, 4.75, 5.0, 5.25, 5.5};
